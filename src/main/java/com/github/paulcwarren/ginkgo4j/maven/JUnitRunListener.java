...
public class JUnitRunListener extends RunListener {
    ...
    private final ThreadLocal<Boolean> testErrored = new ThreadLocal<>();
    ...
    public void testFinished(Description description) {
        if (isTest(description) && testErrored.get() == false) {
            ...
            printWriter = new PrintStream(console, true, StandardCharsets.UTF_8);
            char bullet = '•';
    ...
    public void testFailure(Failure failure) {
        ...
        console.println(outputStream.getByteArrayOutputStream().toString());
