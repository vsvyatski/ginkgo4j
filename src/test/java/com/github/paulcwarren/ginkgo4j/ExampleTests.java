...
public class ExampleTests {
    ...
    {
        Describe("describe", () -> Context("context", () -> {
            something.length();
            It("a test", () -> assertThat(true, is(true)));
        }));

        Describe("", () -> Context("", () ->
                It("", () -> assertThat(true, is(true)))
        ));
        ...
        Describe("A describe", () -> {
            ...
            AfterEach(() -> Assert.assertNull(example));
            ...
            Context("a context", () -> {
                ...
                BeforeEach(() -> example.setStatus("context"));

                AfterEach(() -> example = null);
            ...
            Context("a second context", () -> {
                ...
                BeforeEach(() -> example.setStatus("2nd context"));
        ...
        Context("parent context", () -> {
            ...
            Describe("child context", () -> It("it", () ->
                    It("it", () -> Assert.assertTrue(true))
            ));
        });
    }
}
